...
const IntegrationCard = ({title, description, icon, startegy}: Props) => {
    //WIP: wire up fetching data and get the integrations from db
  return (
    <div className='border-2 border-[#3352CC] rounded-2xl gap-x-5 p-5 flex items-center justify-between'>
        ...
        // disabled={integrated?.name === startegy} 
